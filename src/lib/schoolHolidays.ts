/**
 * school_holidays subscription + lookup helpers. Mirror of the parent
 * dashboard helper — same shape so all 4 dashboards behave identically.
 * See parent-dashboard/src/lib/schoolHolidays.ts for architecture notes.
 */
