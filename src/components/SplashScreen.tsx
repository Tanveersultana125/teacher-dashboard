...
const SESSION_KEY = "edullent_teacher_splash_shown_v1";
...
/* Defensive override so any future global Plus-Jakarta/Montserrat rule
   on * or *::before won't beat the wordmark's Mokoto. */
.edu-splash__wordmark,
